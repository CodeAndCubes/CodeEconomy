 ...
 *
 * <p>
 * Реализацию чужой мод берёт из реестра ядра, где она живёт весом {@code BUILTIN}. Чтения работают из
 * любого потока без блокировок и отвечают по последнему записанному состоянию.
 *
 * <p>
...
public interface EconomyService {
    ...
    /** Все валюты в порядке их объявления в файле. */
