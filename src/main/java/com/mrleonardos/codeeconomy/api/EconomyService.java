...
public interface EconomyService {
    ...
    /**
     * Все валюты: сначала та, что стоит в {@code [economy] defaultCurrency}, дальше по идентификатору.
     *
     * <p>
     * Порядок строк файла сюда не доезжает: разбор toml кладёт секции в неупорядоченную карту. Владелец
     * роли с единственной валютой отвечает списком из одного элемента.
     */
